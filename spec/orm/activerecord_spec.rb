...
describe CarrierWave::ActiveRecord do
  ...
  describe '#mount_uploader' do
    ...
    describe '#save' do
      ...
      it "should mark image as changed when saving a new image" do
        expect(@event.image_changed?).to be false
        @event.image = stub_file("test.jpeg")
        expect(@event.image_changed?).to be true
        @event.save
        @event.reload
        expect(@event.image_changed?).to be false
        @event.image = stub_file("test.jpg")
        expect(@event.image_changed?).to be true
        expect(@event.changed_for_autosave?).to be true
      end
    end
  ...
  describe '#mount_uploader removing old files' do
    ...
    before do
      ...
      @event.image = stub_file('old.jpeg')
      expect(@event.save).to be true
      expect(File.exist?(public_path('uploads/old.jpeg'))).to be true
    end
    ...
    describe 'normally' do
      it "should remove old file if old file had a different path" do
        ...
        expect(@event.save).to be true
        expect(File.exist?(public_path('uploads/new.jpeg'))).to be true
        expect(File.exist?(public_path('uploads/old.jpeg'))).to be false
      end
    ...
    describe 'with an overriden filename' do
      before do
        ...
        @event.foo = 'test'
        expect(@event.save).to be true
        expect(File.exist?(public_path('uploads/test.jpeg'))).to be true
  ...
  describe '#mount_uploader removing old files with versions' do
    ...
    before do
      ...
      expect(@event.save).to be true
      expect(File.exist?(public_path('uploads/old.jpeg'))).to be true
      expect(File.exist?(public_path('uploads/thumb_old.jpeg'))).to be true
    end
    ...
    it "should remove old file if old file had a different path" do
      ...
      expect(@event.save).to be true
      expect(File.exist?(public_path('uploads/new.jpeg'))).to be true
      expect(File.exist?(public_path('uploads/thumb_new.jpeg'))).to be true
      expect(File.exist?(public_path('uploads/old.jpeg'))).to be false
      expect(File.exist?(public_path('uploads/thumb_old.jpeg'))).to be false
    end
  ...
  describe '#mount_uploader removing old files with multiple uploaders' do
    ...
    before do
      ...
      expect(@event.save).to be true
      expect(File.exist?(public_path('uploads/old.jpeg'))).to be true
      expect(File.exist?(public_path('uploads/old.txt'))).to be true
    end
    ...
    it "should remove old file1 and file2 if old file1 and file2 had a different paths" do
      ...
      expect(File.exist?(public_path('uploads/new.jpeg'))).to be true
      expect(File.exist?(public_path('uploads/old.jpeg'))).to be false
      expect(File.exist?(public_path('uploads/new.txt'))).to be true
      expect(File.exist?(public_path('uploads/old.txt'))).to be false
    end
